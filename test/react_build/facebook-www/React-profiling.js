...
React$1.unstable_withSuspenseConfig = function(scope, config) {
...
React$1.unstable_useResponder = function(responder, listenerProps) {
  return resolveDispatcher().useResponder(
    responder,
    listenerProps || emptyObject$1
  );
};
React$1.unstable_createResponder = function(displayName, responderConfig) {
  return {
...
React$1.unstable_createScope = function() {
  return { $$typeof: REACT_SCOPE_TYPE };
};
React$1.jsx = jsx;
React$1.jsxs = jsx;
React$1.unstable_SuspenseList = React$1.SuspenseList;
var ReactFB = { default: React$1 },
  ReactFB$1 = (ReactFB && React$1) || ReactFB;
module.exports = ReactFB$1.default || ReactFB$1;
