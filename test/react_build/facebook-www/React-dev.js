...
if (exposeConcurrentModeAPIs) {
  React$1.useTransition = useTransition;
  React$1.useDeferredValue = useDeferredValue;
  React$1.SuspenseList = REACT_SUSPENSE_LIST_TYPE;
  React$1.unstable_withSuspenseConfig = withSuspenseConfig;
}

if (enableFlareAPI) {
  React$1.unstable_useResponder = useResponder;
  React$1.unstable_createResponder = createEventResponder;
}

if (enableFundamentalAPI) {
  React$1.unstable_createFundamental = createFundamentalComponent;
}

if (enableScopeAPI) {
  React$1.unstable_createScope = createScope;
...
if (enableJSXTransformAPI) {
  {
    React$1.jsxDEV = jsxWithValidation;
    React$1.jsx = jsxWithValidationDynamic;
    React$1.jsxs = jsxWithValidationStatic;
  }
}

React$1.unstable_SuspenseList = React$1.SuspenseList;

var ReactFB = (Object.freeze || Object)({
  default: React$1
});

var ReactFB$1 = (ReactFB && React$1) || ReactFB;

// TODO: decide on the top-level export form.
// This is hacky but makes it work with both Rollup and Jest.

var index_fb = ReactFB$1.default || ReactFB$1;
