...
function dispatchDetachedVisibleNodeEvent(child) {
  if (selectionInformation && child === selectionInformation.focusedElem) {
    var targetFiber = getClosestInstanceFromNode(child);
    dispatchEventForResponderEventSystem(
      "detachedvisiblenode",
      targetFiber,
      { target: child, timeStamp: Date.now() },
      child,
      6
    );
  }
      ...
      currentParentIsContainer
        ? ((finishedRoot = currentParent),
          ...
          finishedRoot.nodeType === COMMENT_NODE
            ...
            : (dispatchDetachedVisibleNodeEvent(root),
        ...
        switch (workInProgress$jscomp$0.tag) {
          ...
          case 13:
            ...
            var nextDidTimeout = null !== nextState,
              prevDidTimeout = !1;
            if (null === current)
              void 0 !== workInProgress$jscomp$0.memoizedProps.fallback &&
                popHydrationState(workInProgress$jscomp$0);
            else {
                  ...
                  for (
                    ...
                    if (null !== suspended) {
                      ...
                      null === renderState.lastEffect &&
                        (workInProgress$jscomp$0.firstEffect = null);
                      workInProgress$jscomp$0.lastEffect =
          ...
          default:
            throw Error(
              formatProdErrorMessage(156, workInProgress$jscomp$0.tag)
            );
        }
        next = null;
      }
