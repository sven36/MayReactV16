...
function toWarnDev(msg, deprecated) {
  ...
  if (process && undefined === 'development') {
    throw msg;
  }
}
...
var PureComponent = miniCreateClass(function () {
...
function createContext(defaultValue, calculateChangedBits) {
  ...
  var Consumer = miniCreateClass(function () {
...
var Unbatch = miniCreateClass(function (props) {
  this.state = {
    child: props.child
  };
}, Component, {
