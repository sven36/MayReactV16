...
export declare function findDOMfromVNode(vNode: VNode, start: boolean): Element | null;
...
export declare function isSameLinkEvent(lastValue: any, nextValue: any): boolean;
