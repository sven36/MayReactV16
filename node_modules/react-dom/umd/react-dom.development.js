    ...
    default:
      {
        ...
        // a boundary.
        {
          if (revealOrder !== undefined && !didWarnAboutRevealOrder[revealOrder]) {
            ...
            warning$1(false, '"%s" is not a supported revealOrder on <SuspenseList />. ' + 'Did you mean "together"?', revealOrder);
          }
        }
...
var hasBadMapPolyfill$1 = void 0;

{
  hasBadMapPolyfill$1 = false;
  try {
    var frozenObject = Object.freeze({});
    var testMap$1 = new Map([[frozenObject, null]]);
    var testSet$1 = new Set([frozenObject]);
    // This is necessary for Rollup to not consider these unused.
    // https://github.com/rollup/rollup/issues/1771
    // TODO: we can remove these if Rollup fixes the bug.
    testMap$1.set(0, 0);
...
if (enableEventAPI) {
  ReactDOM.unstable_createEvent = createEventComponent;
}
